            ...
            <div class="form-group col-md-2">
                <c:if test="${searchForm.isEmpty() eq false}">
                    <a href="/pet/clear" class="btn btn-success">
                        <span class="glyphicon glyphicon-refresh"></span>Wyczyść
                    </a>
                </c:if>
            </div>
                            ...
                            <div class="card h-75" style="min-height: 450px">
                                <div style="height:170px">
                                    <a href="<c:url value="/pet/${pet.id}"/>"><img
                                            ...
                                            src="${pet.images[0]}" alt=""></a>
                                </div>
                                <div class="card-body">
                                    <h4 class="card-title">
                                        <a href="<c:url value="/pet/${pet.id}"/>">${pet.name}</a>
                                    </h4>
                                    <h5><fmt:formatNumber value="${pet.price}" type="currency"
                                    ...
                                    <div class="card-footer">
                                        <div class="row">
                                            ...
                                            <security:authorize access="hasRole('ROLE_ADMIN')">
                                                <input class="btn peach-gradient" style="height:45px" type="button"
                                                       onclick="location.href='/pet/edit/${pet.id}'" value="Edytuj"/>
                                            </security:authorize>
                                        </div>
                                    </div>
                                </security:authorize>
