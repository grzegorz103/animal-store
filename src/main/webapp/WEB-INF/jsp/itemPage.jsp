        ...
        <div class="col-lg-9">
            ...
            <div class="card mt-4">
                <div class="card-body">
                    ...
                    <ul>
                        <li>Kategoria: ${animal.type.category}</li>
                        <c:if test="${animal['class'].simpleName == 'Pet'}">
                        <li>Wiek: ${animal.age} miesięcy</c:if></li>
            ...
            <div class="card card-outline-secondary my-4">
                ...
                <div class="card-body">
                    ...
                    <sec:authorize access="isAnonymous()"><a href="/login">Zaloguj
                        się</a>, aby kupić przedmiot</sec:authorize>
                </div>
            </div>
            <!-- /.card -->
        </div>
