...
<div class="center">
    <form:form modelAttribute="user">
        <h1 style="text-align:center" class="text-dark">Rejestracja</h1>
        <p class="text-danger"><b>Pola wymagane</b></p>
        ...
        <div class="md-form">
            <form:password path="password" cssClass="form-control"
                           required="true" placeholder="Hasło" cssErrorClass="form-control is-invalid"/>
        ...
        <div class="md-form">
            <form:password path="passwordConfirm" cssClass="form-control"
                           ...
                           required="true" placeholder="Powtórz hasło"/>
        </div>

        <div class="md-form">
            <form:input path="email" cssClass="form-control"
                           required="true" placeholder="Adres e-mail" cssErrorClass="form-control is-invalid"/>
        ...
        <div class="collapse" id="collapseExample">
            ...
            <div class="mt-3">
                <div class="md-form">
                    <form:input path="address.name" cssClass="form-control" placeholder="Imię"
            ...
            <div class="mt-3">
                <div class="md-form">
                    <form:input path="address.surname" cssClass="form-control" placeholder="Nazwisko"
                                autofocus="true" cssErrorClass="form-control is-invalid"/>
            ...
            <div class="mt-3">
                <div class="md-form">
                    <form:input path="address.phoneNumber" cssClass="form-control" placeholder="Number telefonu"
                                autofocus="true" cssErrorClass="form-control is-invalid"/>
                 </div>
            </div>
        ...
        <div class="row">
            <div class="col-xs-6 col-sm-6 col-md-6">
                <input type="submit" class="btn btn-lg btn-block btn-success " value="Zarejestruj"/>
            </div>
            <div class="col-xs-6 col-sm-6 col-md-6">
            </div>
        </div>
